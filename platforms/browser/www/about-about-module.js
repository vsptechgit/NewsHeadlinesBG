...
var AboutPage = /** @class */ (function () {
    function AboutPage(apiService) {
        this.apiService = apiService;
    }
    AboutPage.prototype.ionViewDidEnter = function () {
        var _this = this;
        this.apiService.getNewsUs().subscribe(function (data) {
            console.log(data);
